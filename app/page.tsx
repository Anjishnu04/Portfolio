        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { img: "https://i.ibb.co/Bv3g6vb/Screenshot-2026-04-04-193848.png", github: "https://github.com/Anjishnu04/To-Do-List", tags: ["React", "TS", "nextjs", "talwindcss"], name: "To-Do List", desc:"A simple, interactive to-do list app with task creation, completion toggling, and deletion — built with Next.js, React, TypeScript, and Tailwind CSS, featuring clean task management with filtering, progress stats, and an intuitive UI." },
              { img: "https://i.ibb.co/6cVJwwz6/Screenshot-2026-04-04-190312.png", github: "https://github.com/Anjishnu04/sparkle", tags: ["React", "TS", "nextjs", "talwindcss", "SaaS"], name: "Sparkle", desc:"Playful geometric SaaS landing page built with Next.js 14 + Tailwind CSS - Memphis-inspired hard shadows, candy buttons & confetti shape"},
              { img: "https://i.ibb.co/4Zd3nzg7/Phish-Guard-Ai.png", github: "https://github.com/Anjishnu04/PhishGuard-Ai", tags: ["React", "Vite", "AI", "node.js", "Python", "JS"], name: "PhishGuard AI", desc: "AI-powered phishing detection web app built with React frontend, Node.js backend, and Python ML model. Users can input URLs to get real-time safety analysis using a custom-trained model." }
