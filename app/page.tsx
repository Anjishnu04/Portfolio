        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { img: "https://i.ibb.co/6cVJwwz6/Screenshot-2026-04-04-190312.png", github: "https://github.com/Anjishnu04/sparkle", tags: ["React", "TS", "nextjs", "talwindcss"], name: "Sparkle", desc:"Playful geometric SaaS landing page built with Next.js 14 + Tailwind CSS - Memphis-inspired hard shadows, candy buttons & confetti shape"},
            ].map((p) => (
