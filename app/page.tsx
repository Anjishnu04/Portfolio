        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { img: "https://i.ibb.co/Bv3g6vb/Screenshot-2026-04-04-193848.png", github: "https://github.com/Anjishnu04/To-Do-List", tags: ["React", "TS", "nextjs", "talwindcss"], name: "To-Do List", desc:"A simple, interactive to-do list app with task creation, completion toggling, and deletion — built with vanilla JavaScript for clean state management." },
